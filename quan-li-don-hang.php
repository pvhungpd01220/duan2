...
<section class="col-sm-9">
    ...
    <table class="col-sm-12" style="margin-top: 30px; background-color: white; width:100%;">
      <tr>
                                <td  style="color:red; font-size: 16px;width: 8%; height:40px; text-align:center;padding-top:10px; ">Mã đơn hàng</td>
                                <td  style="color:red; font-size: 16px;width: 15%">Họ và tên</td>
                                <td style="color:red;font-size: 16px;width: 15%">Điện thoại</td>
                                <td style="color:red;font-size: 16px;width: 10%"> Email</td>
                                <td style="color:red;font-size: 16px;width: 10%" >Địa chỉ</td>
                                <td style="color:red;font-size: 16px;width: 10%" >Giá tiền</td>
                                <td style="color:red;font-size: 16px;width: 10%" >Thực hiện</td>
                      ...
                      ?>
                        <tr>
                                <td style="color:#020202;padding-top:-200px"><?php echo $value['id_don_hang'] ?></td>
                                <td style="color:#020202;padding-top:20px"><?php echo $value['ho_ten'] ?></td>
                                
                                <td style="color:#020202;"><?php echo $value['dien_thoai'] ?></td>
                                <td style="color:#020202;"><?php echo $value['email'] ?></td>
                                <td style="color:#020202;"><?php echo $value['dia_chi'] ?></td>
                               
                                <td style="color:#020202;"><?php echo $value['gia_tien'] ?></td>
                                <td style="color:#020202;"><a href="xoadonhang.php?id_don_hang=<?=$value['id_don_hang'] ?>">xóa</a><br><a href="update.php?id=<?=$value['pro_id'] ?>">sửa</a></td>
      </tr>
